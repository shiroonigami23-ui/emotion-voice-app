...
I carefully selected a suite of industry-standard libraries to handle the complexity of audio data and deep learning.

- **Librosa:** Used for high-fidelity audio processing. It allowed me to perform "Kaiser Fast" resampling and extract **MFCCs**, converting raw sound waves into numerical fingerprints.
- **TensorFlow & Keras:** The engine of the project. I used Keras's Sequential API to build a Deep Neural Network capable of learning complex emotional patterns.
- **Scikit-Learn (Sklearn):** Crucial for data integrity. I used its `StandardScaler` to normalize audio features and `LabelEncoder` to manage emotional categories.
...
Utilized a **Deep Neural Network (DNN)** designed for classification.
...
- **Balanced Undersampling:** limited data to 496 samples per class to eliminate "Majority Bias," ensuring the AI doesn't just guess the most frequent emotion.
